...
export default function Hero({ onWhatsAppOrder, onPlayVideo }: HeroProps) {
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-sky-500 to-sky-600 text-white border-b border-sky-600/10 min-h-[620px] flex items-stretch">
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 grid lg:grid-cols-12 gap-8 lg:gap-0 items-center py-16 lg:py-0">
        
        {/* Banner Left Info Block */}
        <div className="lg:col-span-7 flex flex-col justify-center space-y-6 z-10 pr-0 lg:pr-8 py-16 lg:py-24">
          ...
          <p className="text-sm md:text-base text-sky-100 leading-relaxed max-w-md">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
            <a
              href="#shop"
              className="bg-white hover:bg-sky-50 text-primary font-extrabold px-8 py-3.5 rounded-xl text-xs uppercase tracking-wider shadow-lg transition text-center"
            >
              Order Direct Online
            </a>
            <button
              onClick={() => onWhatsAppOrder("Hello! I want to buy A2 Bilona Ghee from your banner.")}
              className="flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 active:scale-95 transition-all text-white font-extrabold px-6 py-3.5 rounded-lg text-xs uppercase tracking-wider shadow-lg cursor-pointer whitespace-nowrap"
            >
              Order on WhatsApp
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 text-white border-2 border-white/70 hover:border-white hover:bg-white/10 font-extrabold text-xs uppercase tracking-wider px-5 py-3.5 rounded-xl transition cursor-pointer"
            >
